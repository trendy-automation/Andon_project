...
#include <QPushButton>
        ...
        //sounds:
        #define CLICK_SOUND                     ":/sounds/sounds/click.wav" // in future version of QT QSound will support loader from resource file
	//
	...
	#define _QKEYPUSHBUTTON_H
        ...
        #define DEFAULT_STYLE_BUTTON            "color:white;border: 1px solid #000000;border-radius:6px;font: bold 16px;"
