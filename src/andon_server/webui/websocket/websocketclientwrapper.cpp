    ...
    , m_server(server)
{
    ...
    connect(server, &QWebSocketServer::closed,
            this, &WebSocketClientWrapper::closed);
}
...
void WebSocketClientWrapper::handleNewConnection()
{
    ...
    connect(pSocket, &QWebSocket::disconnected, this, &WebSocketClientWrapper::socketDisconnected);
    m_clients << pSocket;
    emit clientConnected(new WebSocketTransport(pSocket));
//    qDebug()<<"WebSocketClientWrapper emit clientConnected" << pSocket;
}

void WebSocketClientWrapper::socketDisconnected()
{
