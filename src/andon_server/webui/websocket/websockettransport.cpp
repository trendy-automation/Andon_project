...
//    qDebug() << "WebSocketTransport::sendMessage"<<msg.left(40);
//    if (m_socket){
        m_socket->sendTextMessage(msg);
//        qDebug() << msg.left(80);
//    }
//    else
//        qDebug() << "WebSocketTransport::sendMessage no m_socket!!!!!!!!!!!!";

    //qDebug() << "m_socket->peerAddress()" << m_socket->peerAddress()<<m_socket->peerPort()<<m_socket->peerName();
    //qDebug() << "m_socket->localAddress()" << m_socket->localAddress()<<m_socket->localPort();
//    qDebug() << "WebSocketTransport::sendMessage"<<msg;
}
...
//    qDebug() << "WebSocketTransport::textMessageReceived message:"<<message;
    emit messageReceived(message.object(), this);
    //if (message.object().toVariantMap().contains("args"))
    //    qDebug()<<message.object().toVariantMap().value("args").toStringList().at(0);
}
